...
<html>
   ...
   <link rel="stylesheet" href="stylesheet.css">
		<title>Counter Offer Sent</title>
	</head>
...
<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == "POST") {
		...
		//make sure that 2 games were selected
		if ($gameid1 == '' || $gameid2 == '') {
		...
		//retrieve the username and game title and console for the user sending the offer
		...
		//retrieve the username and game title and console for the user receiving the offer
		...
		//delete the original offer from the table
		$delete_query = "DELETE FROM tbx_TradeTable WHERE tradeid='$tradeid'";
		$connection->query($delete_query);

		//echo $tradeid;
		
		//insert the new offer into the table
...
?>
	...
	<body background="images/background.jpg">
		...
		<h2>Your counter offer has been sent!</h2><br><br>
